...
# Base
from platform_painless.services.abstract import AbstractGunicornGenerator

# Helpers
from platform_painless.utils.comment_service import CommentService
...
class GunicornGenerator(
    ...
    def generate(self, diagram_path, git_support=False):
        """generate conf.py
        template:
            platform_painless/templates/conf.jinja
        """
