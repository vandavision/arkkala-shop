...
# Base
from platform_painless.services.abstract import AbstractModelGenerator
...
# Validators
from platform_painless.validators.setting_validator import SettingValidator
...
class ModelGenerator(AbstractModelGenerator, JinjaHandler, JsonHandler, Pep8, FileService, TimingService, GitSupport):
    ...
    def generate(self, diagram_path: str, app_name: str, cache_support: bool = False, git_support: bool = False):
        ...
        templates:
            platform_painless/templates/models.jinja
            platform_painless/templates/signals.jinja
            platform_painless/templates/mixins.jinja
            platform_painless/templates/services.jinja
        """
