...
# Base
from platform_painless.services.abstract import AbstractToxGenerator
...
class ToxGenerator(AbstractToxGenerator, JinjaHandler, JsonHandler, Pep8, TimingService, GitSupport):
    ...
    def generate(self, diagram_path, git_support=False):
        ...
        template:
            platform_painless/templates/tox.jinja
            platform_painless/templates/coveragerc.jinja
            platform_painless/templates/setup.jinja
        """
