...
# Base
from platform_painless.services.abstract import AbstractDockerGenerator
...
from platform_painless.utils.package_manager_service import PackageManagerSupport
...
class DockerGenerator(AbstractDockerGenerator, JinjaHandler, JsonHandler, TimingService, GitSupport, PackageManagerSupport):
    ...
    def generate(
        ...
        template:
            platform_painless/templates/Dockerfile.jinja
            platform_painless/templates/docker-compose.jinja
        """
