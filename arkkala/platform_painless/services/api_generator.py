...
# Base
from platform_painless.services.abstract import AbstractAPIGenerator
...
class APIGenerator(AbstractAPIGenerator, JinjaHandler, JsonHandler, Pep8, FileService, TimingService, GitSupport):
    ...
    def generate(self, diagram_path: str, app_name: str, cache_support: bool = False, git_support: bool = False):
        ...
        template:
            platform_painless/templates/serializers.jinja
            platform_painless/templates/views.jinja
            platform_painless/templates/urls.jinja
        """
